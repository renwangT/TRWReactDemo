/* WebUploader 0.1.2 */ !(function(a, b) {
  ...
  return (
    ...
    b('preset/flashonly', ['base', 'widgets/filepicker', 'widgets/image', 'widgets/queue', 'widgets/runtime', 'widgets/upload', 'widgets/validator', 'runtime/flash/filepicker', 'runtime/flash/image', 'runtime/flash/transport'], function(
      a,
    ) {
      return a;
    }),
