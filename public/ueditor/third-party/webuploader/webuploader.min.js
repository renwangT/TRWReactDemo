/* WebUploader 0.1.2 */ !(function(a, b) {
  ...
  return (
    ...
    b('lib/filepicker', ['base', 'runtime/client', 'lib/file'], function(b, c, d) {
      ...
      var f = b.$;
      return (
        (e.options = { button: null, container: null, label: null, innerHTML: null, multiple: !0, accept: null, name: 'file' }),
        b.inherits(c, {
          constructor: e,
          init: function() {
            var b = this,
    ...
    b('widgets/filepicker', ['base', 'uploader', 'lib/filepicker', 'widgets/widget'], function(a, b, c) {
      ...
      return (
        ...
        b.register(
          { 'add-btn': 'addButton', refresh: 'refresh', disable: 'disable', enable: 'enable' },
          {
            init: function(a) {
            ...
            addButton: function(b) {
              ...
              if (b)
                return (
                  ...
                  (e = d.extend({}, b, { accept: d.isPlainObject(j) ? [j] : j, swf: i.swf, runtimeOrder: i.runtimeOrder })),
                  (f = new c(e)),
    ...
    b('widgets/image', ['base', 'uploader', 'lib/image', 'widgets/widget'], function(a, b, c) {
      ...
      return (
        ...
        b.register(
          { 'make-thumb': 'makeThumb', 'before-send-file': 'compressImage' },
          {
            ...
            compressImage: function(b) {
              ...
              return (
                ...
                !g || !~'image/jpeg,image/jpg'.indexOf(b.type) || b.size < h || b._compressed
                  ? void 0
                  : ((g = e.extend({}, g)),
                    (f = a.Deferred()),
                    (d = new c(g)),
    ...
    b('file', ['base', 'mediator'], function(a, b) {
      ...
      return (
        ...
        b.installTo(d.prototype),
        (d.Status = { INITED: 'inited', QUEUED: 'queued', PROGRESS: 'progress', ERROR: 'error', COMPLETE: 'complete', CANCELLED: 'cancelled', INTERRUPT: 'interrupt', INVALID: 'invalid' }),
        d
      );
    }),
    ...
    b('lib/transport', ['base', 'runtime/client', 'mediator'], function(a, b, c) {
      ...
      var e = a.$;
      return (
        (d.options = { server: '', method: 'POST', withCredentials: !1, fileVal: 'file', timeout: 12e4, formData: {}, headers: {}, sendAsBinary: !1 }),
        e.extend(d.prototype, {
    ...
    b('widgets/upload', ['base', 'uploader', 'file', 'lib/transport', 'widgets/widget'], function(a, b, c, d) {
      function e(a, b) {
        for (var c, d = [], e = a.source, f = e.size, g = b ? Math.ceil(f / b) : 1, h = 0, i = 0; g > i; ) (c = Math.min(b, f - h)), d.push({ file: a, start: h, end: b ? h + c : f, total: f, chunks: g, chunk: i++ }), (h += c);
        return (
          (a.blocks = d.concat()),
          (a.remaning = d.length),
          {
      ...
      var f = a.$,
        g = a.isPromise,
        h = c.Status;
      f.extend(b.options, { prepareNextFile: !1, chunked: !1, chunkSize: 5242880, chunkRetry: 2, threads: 3, formData: null }),
        b.register(
          { 'start-upload': 'start', 'stop-upload': 'stop', 'skip-file': 'skipFile', 'is-in-progress': 'isInProgress' },
          {
            init: function() {
              var b = this.owner;
              (this.runing = !1),
            ...
            _tick: function() {
              ...
              return d._promise
                ...
                : void (d.pool.length < e.threads && (c = d._nextBlock())
                    ? ((d._trigged = !1),
                      (b = function(b) {
            ...
            _nextBlock: function() {
              var a,
                ...
                d = c._act,
                f = c.options;
              return d && d.has() && d.file.getStatus() === h.PROGRESS
                ? (f.prepareNextFile && !c.pending.length && c._prepareNextFile(), d.fetch())
                : c.runing
                ? (!c.pending.length && c.getStats().numOfQueue && c._prepareNextFile(),
                  (a = c.pending.shift()),
                  (b = function(a) {
                    return a ? ((d = e(a, f.chunked ? f.chunkSize : 0)), (c._act = d), d.fetch()) : null;
                  }),
                  g(a) ? a[a.pipe ? 'pipe' : 'then'](b) : b(a))
                : void 0;
            },
              ...
              (b.transport = l),
                ...
                l.on('error', function(a, d) {
                  (b.retried = b.retried || 0),
                    b.chunks > 1 && ~'http,abort'.indexOf(a) && b.retried < j.chunkRetry
                      ? (b.retried++, l.send())
                      : (d || 'server' !== a || (a = c(a)), k.setStatus(h.ERROR, a), i.trigger('uploadError', k, a), i.trigger('uploadComplete', k));
                }),
                l.on('load', function() {
                  var a;
                  return (a = c()) ? void l.trigger('error', a, !0) : void (1 === k.remaning ? g._finishFile(k, e) : l.destroy());
                }),
                (m = f.extend(m, { id: k.id, name: k.name, type: k.type, lastModifiedDate: k.lastModifiedDate, size: k.size })),
                b.chunks > 1 && f.extend(m, { chunks: b.chunks, chunk: b.chunk }),
    ...
    b('runtime/html5/dnd', ['base', 'runtime/html5/runtime', 'lib/file'], function(a, b, c) {
      ...
      return b.register('DragAndDrop', {
        ...
        _dropHandler: function(a) {
          var b = this,
            f = b.getRuid(),
            g = b.elem.parent().get(0);
          return g && !d.contains(g, a.currentTarget)
            ? !1
            : (b._getTansferFiles(a, function(a) {
                b.trigger(
                  'drop',
                  d.map(a, function(a) {
                    return new c(f, a);
        ...
        _getTansferFiles: function(b, c) {
          var d,
            ...
            l = [],
            m = [];
          for (b = b.originalEvent || b, f = b.dataTransfer, d = f.items, e = f.files, k = !(!d || !d[0].webkitGetAsEntry), i = 0, j = e.length; j > i; i++)
            (g = e[i]), (h = d && d[i]), k && h.webkitGetAsEntry().isDirectory ? m.push(this._traverseDirectoryTree(h.webkitGetAsEntry(), l)) : l.push(g);
          a.when.apply(a, m).done(function() {
            l.length && c(l);
          });
        },
      ...
      return b.register('FilePicker', {
        init: function() {
          ...
          if (
            ...
            j.css({ opacity: 0, width: '100%', height: '100%', display: 'block', cursor: 'pointer', background: '#ffffff' }),
    ...
    b('runtime/html5/jpegencoder', [], function() {
      function a(a) {
        function b(a) {
          ...
          for (var h = [1, 1.387039845, 1.306562965, 1.175875602, 1, 0.785694958, 0.5411961, 0.275899379], i = 0, j = 0; 8 > j; j++)
        ...
        function j(a, b) {
          ...
          var _;
          for (k = 0; n > k; ++k) (_ = a[k] * b[k]), (F[k] = _ > 0 ? (_ + 0.5) | 0 : (_ - 0.5) | 0);
          return F;
        }
        function k() {
    ...
    b('runtime/html5/androidpatch', ['runtime/html5/util', 'runtime/html5/jpegencoder', 'base'], function(a, b, c) {
      ...
      a.canvasToDataUrl = function(a, f, g) {
        ...
        return c.os.android
          ? ('image/jpeg' === f &&
              'undefined' == typeof d &&
              ((k = e.apply(null, arguments)), (l = k.split(',')), (k = ~l[0].indexOf('base64') ? atob(l[1]) : decodeURIComponent(l[1])), (k = k.substring(0, 2)), (d = 255 === k.charCodeAt(0) && 216 === k.charCodeAt(1))),
            'image/jpeg' !== f || d ? e.apply(null, arguments) : ((i = a.width), (j = a.height), (h = a.getContext('2d')), b.encode(h.getImageData(0, 0, i, j), g)))
        ...
        getAsBlob: function(a) {
          ...
          if (((a = a || this.type), this.modified || this.type !== a)) {
            if (((b = this._canvas), 'image/jpeg' === a)) {
              if (((d = c.canvasToDataUrl(b, 'image/jpeg', e.quality)), e.preserveHeaders && this._metas && this._metas.imageHead))
      ...
      return b.register('Transport', {
        ...
        send: function() {
          var b,
            ...
            j = g.server;
          g.sendAsBinary
            ? ((j += (/\?/.test(j) ? '&' : '?') + d.param(f._formData)), (c = i.getSource()))
            : ((b = new FormData()),
        ...
        _initAjax: function() {
          var a = this,
            ...
            d = this.options;
          return (
            !d.withCredentials || 'withCredentials' in b || 'undefined' == typeof XDomainRequest || (b = new XDomainRequest()),
              ...
              return 4 === b.readyState
                ? ((b.upload.onprogress = c),
                  ...
                  b.status >= 200 && b.status < 300
                    ...
                    ? ((a._response = b.responseText), a.trigger('error', 'server'))
        ...
        b.inherits(c, {
          ...
          init: function() {
            var a,
              c = this.getContainer(),
              d = this.options;
            c.css({ position: 'absolute', top: '-8px', left: '-8px', width: '9px', height: '9px', overflow: 'hidden' }),
    ...
    b('runtime/flash/filepicker', ['base', 'runtime/flash/runtime'], function(a, b) {
      ...
      return b.register('FilePicker', {
        init: function(a) {
          ...
          delete e.button, delete e.container, this.flashExec('FilePicker', 'init', e);
        },
        destroy: function() {},
      });
    }),
      ...
      return b.register('Transport', {
        ...
        send: function() {
          ...
          e.connectRuntime(f.ruid),
            c.sendAsBinary
              ? ((g += (/\?/.test(g) ? '&' : '?') + d.param(b._formData)), (a = f.uid))
              : (d.each(b._formData, function(a, b) {
                  e.exec('append', a, b);
                }),
                e.exec('appendBlob', c.fileVal, f.uid, c.filename || b._formData.name || '')),
            this._setRequestHeader(e, c.headers),
            e.exec('send', { method: c.method, url: g }, a);
        },
        getStatus: function() {
          return this._status;
        },
        ...
        _initAjax: function() {
          ...
          return (
            b.on('uploadprogress progress', function(b) {
            ...
            b.on('load', function() {
              ...
              return (
                ...
                (a._xhr = null),
                c >= 200 && 300 > c
                  ? ((a._response = b.exec('getResponse')), (a._responseJson = b.exec('getResponseAsJson')))
                  : c >= 500 && 600 > c
                  ? ((a._response = b.exec('getResponse')), (a._responseJson = b.exec('getResponseAsJson')), (d = 'server'))
                  : (d = 'http'),
                b.destroy(),
                (b = null),
