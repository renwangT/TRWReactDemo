/*! Video.js v4.3.0 Copyright 2013 Brightcove, Inc. https://github.com/videojs/video.js/blob/master/LICENSE */ (function() {
  var b = void 0,
    f = !0,
    h = null,
    l = !1;
  ...
  t = u.q.prototype;
  t.e = function(a, c) {
    c = u.k.B({ className: this.T(), innerHTML: '<div class="vjs-control-content"><span class="vjs-control-text">' + (this.qa || 'Need Text') + '</span></div>', qd: 'button', 'aria-live': 'polite', tabIndex: 0 }, c);
  ...
  function K(a, c) {
    if (a.h && a.h.aa)
      try {
        ...
        throw (a.h[c] === b
          ? u.log('Video.js: ' + c + ' method not defined for ' + a.ia + ' playback technology.', d)
          : 'TypeError' == d.name
          ? (u.log('Video.js: ' + c + ' unavailable on ' + a.ia + ' playback technology element.', d), (a.h.aa = l))
          : u.log(d),
        d);
      }
  }
  ...
  t.controls = function(a) {
    return a !== b
      ? ((a = !!a),
        this.sb !== a && ((this.sb = a) ? (this.u('vjs-controls-disabled'), this.n('vjs-controls-enabled'), this.j('controlsenabled')) : (this.u('vjs-controls-enabled'), this.n('vjs-controls-disabled'), this.j('controlsdisabled'))),
        this)
      : this.sb;
  };
  u.s.prototype.Sb;
  ...
  t.ja = function(a) {
    return a !== b
      ? ((a = !!a),
        a !== this.Qb &&
          ((this.Qb = a)
            ? ((this.ka = f), this.u('vjs-user-inactive'), this.n('vjs-user-active'), this.j('useractive'))
            : ((this.ka = l),
  ...
  P.Hd !== b
    ...
    : (document.mozCancelFullScreen ? ((N = 'moz'), (O.H = N + 'FullScreen')) : ((N = 'webkit'), (O.H = N + 'IsFullScreen')),
      P[N + 'RequestFullScreen'] && ((O.wc = N + 'RequestFullScreen'), (O.nb = N + 'CancelFullScreen')),
  ...
  u.f = u.r.extend({
    i: function(a, c, d) {
      ...
      var g = (this.a = u.e('div', { id: a.id() + '_temp_flash' })),
        j = a.id() + '_flash_api';
      a = a.g;
      var k = u.k.B({ readyFunction: 'videojs.Flash.onReady', eventProxyFunction: 'videojs.Flash.onEvent', errorEventProxyFunction: 'videojs.Flash.onError', autoplay: a.autoplay, preload: a.Qa, loop: a.loop, muted: a.muted }, c.flashVars),
      ...
      if (c.iFrameMode === f && !u.Jc) {
        var r = u.e('iframe', { id: j + '_iframe', name: j + '_iframe', className: 'vjs-tech', scrolling: 'no', marginWidth: 0, marginHeight: 0, frameBorder: 0 });
  ...
  t.Ka = function() {
    ...
    if (g) {
      e = g.fa;
      for (var k, c = 0, d = e.length; c < d; c++) (k = e[c]), (k = new u.Xa(this.b, { track: g, cue: k })), j.push(k), a.Z(k);
    }
