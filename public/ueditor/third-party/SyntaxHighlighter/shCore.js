...
(function(undefined) {
  ...
  String.prototype.match = function(regex) {
    if (!XRegExp.isRegExp(regex)) regex = RegExp(regex); // Native `RegExp`
    if (regex.global) {
...
if (typeof SyntaxHighlighter == 'undefined')
  var SyntaxHighlighter = (function() {
    ...
    function processSmartTabs(code, tabSize) {
      ...
      for (var i = 0; i < 50; i++) spaces += '                    '; // 20 spaces * 50

      // This function inserts specified amount of spaces in the string
      // where a tab is while removing that given tab.
      function insertSpaces(line, pos, count) {
        return (
          line.substr(0, pos) + spaces.substr(0, count) + line.substr(pos + 1, line.length) // pos + 1 will get rid of the tab
        );
      }
...
(function() {
  ...
  function Brush() {
    ...
    this.regexList = [
      ...
      { regex: /\b(?:about|above|against|around|at|below|beneath|beside|between|by|(apart|aside) from|(instead|out) of|into|on(to)?|over|since|thr(ough|u)|under)\b/g, css: 'color3' },
...
(function() {
  ...
  function Brush() {
    ...
    var keywords =
      'auto break case catch class const decltype __finally __exception __try ' +
...
(function() {
  ...
  function Brush() {
    ...
    var keywords =
      'as assert break case catch class continue def default do else extends finally ' + 'if in implements import instanceof interface new package property return switch ' + 'throw throws try while public protected private static';
...
(function() {
  ...
  function Brush() {
    ...
    var keywords =
      'while validateset validaterange validatepattern validatelength validatecount ' +
    ...
    var verbs =
      'write where wait use update unregister undo trace test tee take suspend ' +
