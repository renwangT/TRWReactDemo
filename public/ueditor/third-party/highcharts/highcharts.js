...
(function() {
  ...
  function Eb(a, b, c, d) {
    ...
    if (u(b)) {
      ...
      b = 1;
      h = i[ab]();
      for (var d = i.getTime(), l = i[$a](), m = i[Sa](), p = g ? 0 : (864e5 + i.getTimezoneOffset() * 6e4) % 864e5; d < c; )
  ...
  var jb = G.adapterRun,
    ...
    Bb = G.animate,
    Wa = G.stop,
    G = { enabled: !0, x: 0, y: 15, style: { color: '#666', cursor: 'default', fontSize: '11px', lineHeight: '14px' } };
  M = {
    ...
    global: { useUTC: !0, canvasToolsURL: 'http://code.highcharts.com/3.0.6/modules/canvas-tools.js', VMLRadialGradientURL: 'http://code.highcharts.com/3.0.6/gfx/vml-radial-gradient.png' },
    chart: {
      borderColor: '#4572A7',
      borderRadius: 5,
  ...
  var ra = function(a) {
    ...
    (function(a) {
      a && a.stops
        ...
        : (c = /rgb\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*\)/.exec(a)) && (b = [C(c[1]), C(c[2]), C(c[3]), 1]);
    })(a);
    return {
      get: function(c) {
        var f;
  ...
  wa.prototype = {
    ...
    attr: function(a, b) {
      ...
      if (ea(a)) (c = a), h === 'circle' ? (c = { x: 'cx', y: 'cy' }[c] || c) : c === 'strokeWidth' && (c = 'stroke-width'), (q = v(g, c) || this[c] || 0), c !== 'd' && c !== 'visibility' && c !== 'fill' && (q = parseFloat(q));
      else {
        for (c in a)
          if (((j = !1), (d = a[c]), (e = k[c] && k[c].call(this, d, c)), e !== !1)) {
            e !== w && (d = e);
            if (c === 'd') d && d.join && (d = d.join(' ')), /(NaN| {2}|^$)/.test(d) && (d = 'M 0 0');
            else if (c === 'x' && h === 'text') for (e = 0; e < g.childNodes.length; e++) (f = g.childNodes[e]), v(f, 'x') === v(g, 'x') && v(f, 'x', d);
            ...
            else if (c === 'title') (e = g.getElementsByTagName('title')[0]), e || ((e = y.createElementNS(za, 'title')), g.appendChild(e)), (e.textContent = d);
            c === 'strokeWidth' && (c = 'stroke-width');
            if (c === 'stroke-width' || c === 'stroke') {
              this[c] = d;
              if (this.stroke && this['stroke-width']) v(g, 'stroke', this.stroke), v(g, 'stroke-width', this['stroke-width']), (this.hasStroke = !0);
            ...
            if (l && /^(width|height|visibility|x|y|d|transform|cx|cy|r)$/.test(c)) for (e = l.length; e--; ) v(l[e], c, c === 'height' ? s(d - (l[e].cutHeight || 0), 0) : d);
      ...
      ib && a === 'click'
        ? ((d.ontouchstart = function(a) {
          ...
          (d.onclick = function(a) {
            (oa.indexOf('Android') === -1 || Date.now() - (c.touchEventFired || 0) > 1100) && b.call(d, a);
          }))
        : (d['on' + a] = b);
      return this;
    },
      ...
      if (this.added) {
        ...
        if (b.tagName === 'SPAN') {
          ...
          if (Sb !== this.cTT) {
            ...
            if (k > m && /[ \-]/.test(b.textContent || b.innerText)) K(b, { width: m + 'px', display: 'block', whiteSpace: 'normal' }), (k = m);
    ...
    shadow: function(a, b, c) {
      ...
      if (a) {
        ...
        for (e = 1; e <= i; e++) {
          f = g.cloneNode(0);
          h = i * 2 + 1 - 2 * e;
          v(f, { isShadow: 'true', stroke: a.color || 'black', 'stroke-opacity': j * e, 'stroke-width': h, transform: 'translate' + k, fill: S });
  ...
  Ha.prototype = {
        ...
        n(m, function(e) {
          if (e !== '' || m.length === 1) {
            ...
            if (
              ...
              o ? (p.dx = 0) : (p.x = i),
              v(n, p),
              !o && f && (!Z && d && K(n, { display: 'block' }), v(n, 'dy', l || c.fontMetrics(/px$/.test(n.style.fontSize) ? n.style.fontSize : j.fontSize).h, gb && n.offsetHeight)),
              b.appendChild(n),
              o++,
              k)
            )
              for (var e = e.replace(/([^\^])-/g, '$1- ').split(' '), u, t, p = a._clipHeight, E = [], w = C(l || 16), B = 1; e.length || E.length; )
                delete a.bBox,
                  ...
                  !u || e.length === 1
                    ? ((e = E),
                      (E = []),
                      e.length && (B++, p && B * w > p ? ((e = ['...']), a.attr('title', a.textStr)) : ((n = y.createElementNS(za, 'tspan')), v(n, { dy: w, x: i }), s && v(n, 'style', s), b.appendChild(n), t > k && (k = t))))
    ...
    symbol: function(a, b, c, d, e, f) {
      var g,
        ...
        j,
        k;
      if (h) (g = this.path(h)), r(g, { symbolName: a, x: b, y: c, width: d, height: e }), f && r(g, f);
      else if (i.test(a))
        (k = function(a, b) {
      ...
      if (g) {
        ...
        h[p]
          ...
          : ((c.id = a = 'highcharts-' + zb++),
            ...
            (i.stops = []),
            n(j, function(a) {
              f.test(a[1]) ? ((e = ra(a[1])), (k = e.get('rgb')), (l = e.get('a'))) : ((k = a[1]), (l = 1));
              a = d
                .createElement('stop')
  ...
  if (!Z && !$) {
    Highcharts.VMLElement = F = {
      ...
      setSpanRotation: function(a, b, c) {
        K(this.element, { filter: a ? ['progid:DXImageTransform.Microsoft.Matrix(M11=', c, ', M12=', -b, ', M21=', b, ', M22=', c, ", sizingMethod='auto expand')"].join('') : S });
      },
        ...
        if (ea(a)) (c = a), (q = c === 'strokeWidth' || c === 'stroke-width' ? this.strokeweight : this[c]);
          ...
          for (c in a)
            if (((d = a[c]), (m = !1), (e = p[c] && p[c].call(this, d, c)), e !== !1 && d !== null)) {
              ...
              else if (h === 'shape' && c === 'rotation') (this[c] = f.style[c] = d), (f.style.left = -t(ca(d * Ua) + 1) + 'px'), (f.style.top = t(V(d * Ua)) + 'px');
      ...
      shadow: function(a, b, c) {
        ...
        if (a) {
          ...
          for (e = 1; e <= 3; e++) {
            ...
            h = U(g.prepVML(j), null, { left: C(i.left) + o(a.offsetX, 1), top: C(i.top) + o(a.offsetY, 1) });
            if (c) h.cutOff = l + 1;
    ...
    var ma = {
      ...
      init: function(a, b, c) {
        ...
        y.namespaces.hcv ||
          ...
          ((y.styleSheets.length ? y.styleSheets[0] : y.createStyleSheet()).cssText += 'hcv\\:fill, hcv\\:path, hcv\\:shape, hcv\\:stroke{ behavior:url(#default#VML); display: inline-block; } '));
      },
      isHidden: function() {
      ...
      color: function(a, b, c, d) {
        ...
        if (i) {
          ...
          if (c === 'fill')
            if (i === 'gradient') (c = m.x1 || m[0] || 0), (a = m.y1 || m[1] || 0), (p = m.x2 || m[2] || 0), (m = m.y2 || m[3] || 0), (s = 'angle="' + (90 - (R.atan((m - a) / (p - c)) * 180) / ya) + '"'), w();
            else {
              var j = m.r,
                r = j * 2,
                E = j * 2,
        ...
        } else if (g.test(a) && b.tagName !== 'IMG') (f = ra(a)), (h = ['<', c, ' opacity="', f.get('a'), '"/>']), U(this.prepVML(h), null, null, b), (j = f.get('rgb'));
        else {
    ...
    render: function(a, b, c) {
      ...
      if (i && !isNaN(H))
        (i.xy = E = this.getLabelPosition(H, E, i, g, k, x, a, r)),
          (this.isFirst && !this.isLast && !o(e.showFirstLabel, 1)) || (this.isLast && !this.isFirst && !o(e.showLastLabel, 1)) ? (v = !1) : !C && g && k.overflow === 'justify' && !this.handleOverflow(a, E) && (v = !1),
          r && a % r && (v = !1),
          v && !isNaN(E.y) ? ((E.opacity = c), i[this.isNew ? 'attr' : 'animate'](E), (this.isNew = !1)) : i.attr('y', -9999);
    },
    destroy: function() {
      Ka(this, this.axis);
    },
  ...
  db.prototype = {
    ...
    defaultLabelFormatter: function() {
      ...
      else if (f && a >= 1e3) for (; f-- && g === w; ) (c = Math.pow(1e3, f + 1)), a >= c && e[f] !== null && (g = Aa(b / c, -1) + e[f]);
    ...
    getLogTickPositions: function(a, b, c, d) {
      ...
      if (a >= 0.5) (a = t(a)), (g = this.getLinearTickPositions(a, b, c));
        ...
        (a = o(a === 'auto' ? null : a, this._minorAutoInterval, ((c - b) * (e.tickPixelInterval / (d ? 5 : 1))) / ((d ? f / this.tickPositions.length : f) || 1))),
        (a = ob(a, null, nb(a))),
    ...
    setTickPositions: function(a) {
      var b = this,
        ...
        ba = b.categories;
      h
        ? ((b.linkedParent = c[g ? 'xAxis' : 'yAxis'][d.linkedTo]), (c = b.linkedParent.getExtremes()), (b.min = o(c.min, c.dataMin)), (b.max = o(c.max, c.dataMax)), d.type !== b.linkedParent.options.type && ka(11, 1))
        : ((b.min = o(b.userMin, d.min, b.dataMin)), (b.max = o(b.userMax, d.max, b.dataMax)));
      if (e) !a && I(b.min, o(b.dataMin, b.min)) <= 0 && ka(10, 1), (b.min = ia(na(b.min))), (b.max = ia(na(b.max)));
      ...
      b.min === b.max || b.min === void 0 || b.max === void 0
        ...
        : ((b.tickInterval = o(l, ba ? 1 : ((b.max - b.min) * p) / s(b.len, p))), !u(l) && b.len < p && !this.isRadial && ((q = !0), (b.tickInterval /= 4)));
      g &&
        !a &&
      ...
      if (!a)
        !b.ordinalPositions && (b.max - b.min) / b.tickInterval > s(2 * b.len, 200) && ka(19, !0),
          (a = f
            ? (b.getNonLinearTimeTicks || Eb)(Cb(b.tickInterval, d.units), b.min, b.max, d.startOfWeek, b.ordinalPositions, b.closestPointRange, !0)
            : e
      ...
      if (j || a.isLinked) {
        ...
        if (a.horiz && !a.staggerLines && x && !q.rotation) {
          for (r = a.reversed ? [].concat(e).reverse() : e; v < x; ) {
            j = [];
            la = !1;
            for (q = 0; q < r.length; q++) (E = r[q]), (H = (H = f[E].label && f[E].label.getBBox()) ? H.width : 0), (B = q % v), H && ((E = a.translate(E)), j[B] !== w && E < j[B] && (la = !0), (j[B] = E + H));
            if (la) v++;
            else break;
          }
        ...
        n(e, function(b) {
          if (h === 0 || h === 2 || { 1: 'left', 3: 'right' }[h] === a.labelAlign) ba = s(f[b].getLabelSize(), ba);
        });
      ...
      if (p && p.text && p.enabled !== !1) {
        if (!a.axisTitle)
          (a.axisTitle = c
            ...
            .attr({ zIndex: 7, rotation: p.rotation || 0, align: p.textAlign || { low: 'left', middle: 'center', high: 'right' }[p.align] })
            .css(p.style)
            .add(a.axisGroup)),
            (a.axisTitle.isNew = !0);
    ...
    render: function() {
      ...
      if (A || f)
        if (
          ...
          p &&
            n(g, function(b, c) {
              if (c % 2 === 0 && b < a.max) l[b] || (l[b] = new vb(a)), (r = b + q), (v = g[c + 1] !== w ? g[c + 1] + q : a.max), (l[b].options = { from: e ? fa(r) : r, to: e ? fa(v) : v, color: p }), l[b].render(), (l[b].isActive = !0);
            }),
          !a._addedPlotLB)
        )
  ...
  wb.prototype = {
    init: function(a, b) {
      ...
      this.label = a.renderer
        ...
        .attr({ padding: e, fill: b.backgroundColor, 'stroke-width': c, r: b.borderRadius, zIndex: 8 })
        .css(d)
        .css({ padding: 0 })
        .add()
        .attr({ y: -999 });
    ...
    refresh: function(a, b) {
      ...
      i === !1
        ? this.hide()
        : (this.isHidden && (Wa(d), d.attr('opacity', 1).show()), d.attr({ text: i }), (k = e.borderColor || a.color || h.color || '#606060'), d.attr({ stroke: k }), this.updatePosition({ plotX: f, plotY: g }), (this.isHidden = !1));
      if (l) {
        l = ja(l);
        for (d = l.length; d--; )
          if (((m = a.series), (e = m[d ? 'yAxis' : 'xAxis']), l[d] && e))
            if (((h = d ? o(a.stackY, a.y) : a.x), e.isLog && (h = na(h)), d === 1 && m.modifyValue && (h = m.modifyValue(h)), (e = e.getPlotLinePath(h, 1)), this.crosshairs[d])) this.crosshairs[d].attr({ d: e, visibility: 'visible' });
            else {
              h = { 'stroke-width': l[d].width || 1, stroke: l[d].color || '#C0C0C0', zIndex: l[d].zIndex || 2 };
              if (l[d].dashStyle) h.dashstyle = l[d].dashStyle;
              this.crosshairs[d] = c.renderer
                .path(e)
                .attr(h)
                .add();
            }
  ...
  xb.prototype = {
    ...
    runPointActions: function(a) {
      ...
      if (d && this.options.tooltip.shared && (!g || !g.noSharedTooltip)) {
        ...
        h = c.length;
        for (i = 0; i < h; i++)
          if (c[i].visible && c[i].options.enableMouseTracking !== !1 && !c[i].noSharedTooltip && c[i].tooltipPoints.length && (b = c[i].tooltipPoints[k]) && b.series) (b._dist = N(k - b.clientX)), (j = I(j, b._dist)), e.push(b);
      ...
      if (!b.cancelClick)
        c && this.inClass(a.target, 'highcharts-tracker')
          ? ((g = this.chartPosition),
            (h = c.plotX),
            (i = c.plotY),
            r(c, { pageX: g.left + d + (f ? b.plotWidth - i : h), pageY: g.top + e + (f ? b.plotHeight - h : i) }),
            z(c.series, 'click', r(a, { point: c })),
            b.hoverPoint && c.firePointEvent('click', a))
          : (r(a, this.getCoordinates(a)), b.isInsidePlot(a.chartX - d, a.chartY - e) && z(b, 'click', a));
    },
  ...
  eb.prototype = {
      ...
      if (b)
        (c = b.translateY),
          n(this.allItems, function(e) {
            var f = e.checkbox,
              g;
            f && ((g = c + f.y + (a || 0) + 3), K(f, { left: b.translateX + e.legendItemWidth + f.x - 20 + 'px', top: g + 'px', display: g > c - 6 && g < c + d - 6 ? '' : S }));
          });
    },
    ...
    renderItem: function(a) {
      ...
      if (
        ...
        (a.legendItem = t = d
          .text(e.labelFormat ? Ca(e.labelFormat, a) : e.labelFormatter.call(a), m ? g + h : -h, b.baseline, v)
          .css(x(a.visible ? i : j))
    ...
    render: function() {
      ...
      n(b.series, function(a) {
        var b = a.options;
        b.showInLegend && !u(b.linkedTo) && (e = e.concat(a.legendItems || (b.legendType === 'point' ? a.data : a)));
      });
      Kb(e, function(a, b) {
    ...
    scroll: function(a, b) {
      ...
      if (d > 0)
        b !== w && La(b, this.chart),
          this.nav.attr({ translateX: i, translateY: e + 7 + this.titleHeight, visibility: 'visible' }),
          this.up.attr({ fill: d === 1 ? h : g }).css({ cursor: d === 1 ? 'default' : 'pointer' }),
          f.attr({ text: d + '/' + this.pageCount }),
          this.down.attr({ x: 18 + this.pager.getBBox().width, fill: d === c ? h : g }).css({ cursor: d === c ? 'default' : 'pointer' }),
  ...
  yb.prototype = {
    ...
    showLoading: function(a) {
      ...
      if (!this.loadingShown)
        K(c, { opacity: 0, display: '', left: this.plotLeft + 'px', top: this.plotTop + 'px', width: this.plotWidth + 'px', height: this.plotHeight + 'px' }),
    ...
    getContainer: function() {
      ...
      this.container = a = U(
        ...
        r({ position: 'relative', overflow: 'hidden', width: c + 'px', height: d + 'px', textAlign: 'left', lineHeight: 'normal', zIndex: 0, '-webkit-tap-highlight-color': 'rgba(0,0,0,0)' }, b.style),
    ...
    getMargins: function() {
      ...
      if (c.display && !e.floating)
        ...
        } else if (j === 'bottom' && !u(d[2])) this.marginBottom = s(this.marginBottom, c.legendHeight - h + f + a[2]);
  ...
  Pa.prototype = {
    ...
    setState: function(a) {
      ...
      if (!(a === this.state || (this.selected && a !== 'select') || (e[a] && e[a].enabled === !1) || (a && (i || (g && !h.enabled))))) {
        if (this.graphic) (e = f && this.graphic.symbolName && m[a].r), this.graphic.attr(x(m[a], e ? { x: b - e, y: c - e, width: 2 * e, height: 2 * e } : {}));
        else {
          if (a && h)
            (e = h.radius),
              (k = k.symbol || d.symbol),
              ...
              j
                ? j.attr({ x: b - e, y: c - e })
                : ((d.stateMarkerGraphic = j = l.renderer
  ...
  Q.prototype = {
    ...
    setData: function(a, b) {
      ...
      } else for (i = 0; i < m; i++) if (a[i] !== w && ((d = { series: this }), this.pointClass.prototype.applyOptions.apply(d, [a[i]]), (j[i] = d.x), (k[i] = q ? this.toYData(d) : d.y), (l[i] = d.z), h && d.name)) h[d.x] = d.name;
      ea(k[0]) && ka(14, !0);
      this.data = [];
      this.options.data = a;
      this.xData = j;
    ...
    setStackedPoints: function() {
      if (this.options.stacking && !(this.visible !== !0 && this.chart.options.chart.ignoreHiddenSeries !== !1)) {
        ...
        for (o = 0; o < d; o++) {
          ...
          e === 'percent' ? ((p = p ? h : i), j && l[p] && l[p][n] ? ((p = l[p][n]), (q.total = p.total = s(p.total, q.total) + N(t) || 0)) : (q.total += N(t) || 0)) : (q.total += t || 0);
          q.cum = (q.cum || 0) + (t || 0);
    ...
    translate: function() {
      ...
      this.generatePoints();
      for (
        var a = this.options, b = a.stacking, c = this.xAxis, d = c.categories, e = this.yAxis, f = this.points, g = f.length, h = !!this.modifyValue, i = a.pointPlacement, j = i === 'between' || sa(i), k = a.threshold, a = 0;
        a < g;
        a++
      ) {
        var l = f[a],
    ...
    animate: function(a) {
      ...
      if (a)
        (a = c[h]),
          (e = c[h + 'm']),
          a || ((c[h] = a = d.clipRect(r(f, { width: 0 }))), (c[h + 'm'] = e = d.clipRect(-99, g ? -c.plotLeft : -c.plotTop, 99, g ? c.chartWidth : c.chartHeight))),
          b.group.clip(a),
        ...
        for (f = b.length; f--; )
          if (((g = b[f]), (d = P(g.plotX)), (e = g.plotY), (k = g.graphic), (i = g.marker || {}), (a = (l.enabled && i.enabled === w) || i.enabled), (m = c.isInsidePlot(t(d), e, c.inverted)), a && e !== w && !isNaN(e) && g.y !== null))
            if (((a = g.pointAttr[g.selected ? 'select' : '']), (h = a.r), (i = o(i.symbol, this.symbol)), (j = i.indexOf('url') === 0), k))
              k.attr({ visibility: m ? (Z ? 'inherit' : 'visible') : 'hidden' }).animate(r({ x: d - h, y: e - h }, k.symbolName ? { width: 2 * h, height: 2 * h } : {}));
            else {
              if (m && (h > 0 || j))
    ...
    update: function(a, b) {
      var c = this.chart,
        ...
        e = W[d].prototype,
        f,
        a = x(this.userOptions, { animation: !1, index: this.index, pointStart: this.xData[0] }, { data: this.options.data }, a);
      this.remove(!1);
          ...
          n(c, function(c) {
            ...
            if (j && !i) c.dataLabel = j.destroy();
              ...
              if (j)
                ...
                j = c.dataLabel = a.chart.renderer[i ? 'text' : 'label'](f, 0, -999, null, null, null, b.useHTML)
                  .attr(j)
                  .css(b.style)
                  .add(g)
                  .shadow(b.shadow);
    ...
    alignDataLabel: function(a, b, c, d, e) {
      ...
      if ((a = this.visible && f.isInsidePlot(a.plotX, a.plotY, g)))
        (d = r({ x: g ? f.plotWidth - i : h, y: t(g ? f.plotHeight - h : i), width: 0, height: 0 }, d)),
          r(c, { width: j.width, height: j.height }),
          c.rotation
            ? ((g = { align: c.align, x: d.x + c.x + d.width / 2, y: d.y + c.y + d.height / 2 }), b[e ? 'attr' : 'animate'](g))
            : (b.align(c, null, d), (g = b.alignAttr), o(c.overflow, 'justify') === 'justify' ? this.justifyDataLabel(b, c, g, j, d, e) : o(c.crop, !0) && (a = f.isInsidePlot(g.x, g.y) && f.isInsidePlot(g.x + j.width, g.y + j.height)));
      a || b.attr({ y: -999 });
    },
    ...
    getSegmentPath: function(a) {
      ...
      n(a, function(e, f) {
        ...
        b.getPointSpline
          ...
          : (c.push(f ? 'L' : 'M'), d && f && ((i = a[f - 1]), d === 'right' ? c.push(i.plotX, h) : d === 'center' ? c.push((i.plotX + g) / 2, i.plotY, (i.plotX + g) / 2, h) : c.push(g, i.plotY)), c.push(e.plotX, e.plotY));
      });
      return c;
    },
    ...
    drawTracker: function() {
      ...
      j
        ...
        : ((a.tracker = h
            .path(d)
            .attr({ 'stroke-linejoin': 'round', visibility: a.visible ? 'visible' : 'hidden', stroke: Qb, fill: c ? Qb : S, 'stroke-width': b.lineWidth + (c ? 0 : 2 * i), zIndex: 2 })
            .add(a.group)),
          ...
          : (a[e] = a.chart.renderer
              ...
              .attr({
                fill: o(
                  d[2],
                  ra(d[1])
                    .setOpacity(o(c.fillOpacity, 0.75))
                    .get(),
                ),
                zIndex: 0,
              })
  ...
  ma = G.prototype;
  F = ha(F, { type: 'areaspline', closedStacks: !0, getSegmentPath: ma.getSegmentPath, closeSegment: ma.closeSegment, drawGraph: ma.drawGraph, drawLegendSymbol: ma.drawLegendSymbol });
  W.areaspline = F;
  Y.column = x(X, {
    borderColor: '#FFFFFF',
    borderWidth: 1,
  ...
  F = ha(Q, {
    ...
    getColumnMetrics: function() {
      ...
      b.grouping === !1
        ...
        : n(a.chart.series, function(b) {
            var c = b.options,
              e = b.yAxis;
            if (b.type === a.type && b.visible && d.len === e.len && d.pos === e.pos) c.stacking ? ((f = b.stackKey), g[f] === w && (g[f] = i++), (h = g[f])) : c.grouping !== !1 && (h = i++), (b.columnIndex = h);
          });
    ...
    animate: function(a) {
      ...
      if (Z)
        a
          ? ((e.scaleY = 0.001), (a = I(b.pos + b.len, s(b.pos, b.toPixels(c.threshold)))), d ? (e.translateX = a - b.len) : (e.translateY = a), this.group.attr(e))
  ...
  Y.scatter = x(X, {
    lineWidth: 0,
    tooltip: { headerFormat: '<span style="font-size: 10px; color:{series.color}">{series.name}</span><br/>', pointFormat: 'x: <b>{point.x}</b><br/>y: <b>{point.y}</b><br/>', followPointer: !0 },
    stickyTracking: !1,
  });
      ...
      if (a.visible && (e.enabled || a._hasPointLabels)) {
        ...
        for (H = 2; H--; ) {
          ...
          for (B = 0; B < J; B++) {
            ...
            c = v[1];
            if (l > 0) {
              if (((w = K.pop()), (F = w.i), (z = w.y), (c > z && b[F + 1] !== null) || (c < z && b[F - 1] !== null))) z = c;
            } else z = c;
              ...
              n(this.points, function(b) {
                ...
                if ((r = b.dataLabel) && r._pos)
                  (E = r._attr.visibility),
                    (y = r.connX),
                    (z = r.connY),
                    (j = k ? ['M', y + (v[6] === 'left' ? 5 : -5), z, 'C', y, z, 2 * v[2] - v[4], 2 * v[3] - v[5], v[2], v[3], 'L', v[4], v[5]] : ['M', y + (v[6] === 'left' ? 5 : -5), z, 'L', v[2], v[3], 'L', v[4], v[5]]),
                    i
                      ? (i.animate({ d: j }), i.attr('visibility', E))
                      : (b.connector = i = a.chart.renderer
                          .path(j)
                          .attr({ 'stroke-width': g, stroke: e.connectorColor || b.color || '#606060', visibility: E })
                          .add(a.group));
