...
var HighchartsAdapter = (function() {
  ...
  return {
      ...
      if (hasEffect) {
        ...
        Effect.HighchartsTransition = Class.create(Effect.Base, {
          initialize: function(element, attr, to, options) {
            ...
            if (attr === 'd') {
              this.paths = pathAnim.init(element, element.d, to);
              this.toD = to;
          ...
          update: function(position) {
            ...
            if (element.attr) {
              ...
              if (element.element) {
                // If not, it has been destroyed (#1405)
    ...
    addNS: function(eventName) {
      ...
      return HTMLEvents.test(eventName) || MouseEvents.test(eventName) ? eventName : 'h:' + eventName;
    },
      ...
      if (!object._highcharts_extended) {
        Object.extend(object, {
          ...
          _highcharts_stop_observing: function(name, fn) {
            if (name) {
              if (fn) {
                this._highchart_events[name] = [this._highchart_events[name]]
                  .compact()
                  .flatten()
                  .without(fn);
              } else {
          ...
          _highcharts_fire: function(name, args) {
            var target = this;
            (this._highchart_events[name] || []).each(
              function(fn) {
