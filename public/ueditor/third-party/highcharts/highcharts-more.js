...
(function(j, C) {
  ...
  function L(a, b) {
    ...
    if (c.polar) {
      if (c.renderer.isSVG)
        if ((d === !0 && (d = {}), b)) {
          if (((c = { translateX: e[0] + i, translateY: e[1] + n, scaleX: 0.001, scaleY: 0.001 }), g.attr(c), f)) (f.attrSetters = g.attrSetters), f.attr(c);
        } else (c = { translateX: i, translateY: n, scaleX: 1, scaleY: 1 }), g.animate(c, d), f && f.animate(c, d), (this.animate = null);
    } else a.call(this, b);
  }
  var P = j.arrayMin,
    Q = j.arrayMax,
  ...
  var G = N.prototype,
    ...
    O = {
      ...
      defaultRadialXOptions: { gridLineWidth: 1, labels: { align: null, distance: 15, x: 0, y: null }, maxPadding: 0, minPadding: 0, plotBands: [], showLastLabel: !1, tickLength: 0 },
      defaultRadialYOptions: { gridLineInterpolation: 'circle', labels: { align: 'right', x: -3, y: -2 }, plotBands: [], showLastLabel: !1, title: { x: 4, text: null, rotation: 90 } },
      ...
      getPlotBandPath: function(a, b, c) {
        ...
        this.options.gridLineInterpolation === 'polygon'
          ...
          : (l || ((e[0] = this.translate(a)), (e[1] = this.translate(b))),
            ...
            c.shape === 'circle' || !l ? ((a = -Math.PI / 2), (b = Math.PI * 1.5), (n = !0)) : ((a = g + this.translate(a)), (b = g + this.translate(b))),
            (d = this.chart.renderer.symbols.arc(this.left + d[0], this.top + d[1], e[0], e[0], { start: a, end: b, innerR: r(e[1], e[0] - e[2]), open: n })));
        return d;
      },
  ...
  o(G, 'init', function(a, b, c) {
    ...
    var l = c.pane || 0;
    if (d) {
      if ((F(this, e ? T : O), (i = !f))) this.defaultRadialOptions = this.defaultRadialGaugeOptions;
  ...
  o(u, 'getLabelPosition', function(a, b, c, d, g, f, e, i, n) {
    ...
    l.isRadial
      ? ((a = l.getPosition(this.pos, l.center[2] / 2 + r(f.distance, -25))),
        f.rotation === 'auto' ? d.attr({ rotation: j }) : k === null && (k = v(d.styles.lineHeight) * 0.9 - d.getBBox().height / 2),
        h === null && ((h = l.isCircular ? (j > 20 && j < 160 ? 'left' : j > 200 && j < 340 ? 'right' : 'center') : 'center'), d.attr({ align: h })),
        (a.x += f.x),
        (a.y += k))
  ...
  h.arearange = j.extendClass(h.area, {
    ...
    getSegmentPath: function(a) {
      ...
      a = g.call(this, b);
      if (i) i === !0 && (i = 'left'), (e.step = { left: 'right', center: 'center', right: 'left' }[i]);
      c = g.call(this, c);
      e.step = i;
      e = [].concat(a, c);
      c[0] = 'L';
    ...
    drawDataLabels: function() {
      ...
      if (f.enabled || this._hasPointLabels) {
        for (c = b; c--; ) (e = a[c]), (e.y = e.high), (e.plotY = e.plotHigh), (d[c] = e.dataLabel), (e.dataLabel = e.dataLabelUpper), (e.below = !1), i ? ((f.align = 'left'), (f.x = f.xHigh)) : (f.y = f.yHigh);
        g.drawDataLabels.apply(this, arguments);
        for (c = b; c--; ) (e = a[c]), (e.dataLabelUpper = e.dataLabel), (e.dataLabel = d[c]), (e.y = e.low), (e.plotY = e.plotLow), (e.below = !0), i ? ((f.align = 'right'), (f.x = f.xLow)) : (f.y = f.yLow);
        g.drawDataLabels.apply(this, arguments);
      }
    },
  ...
  m.gauge = p(m.line, {
    dataLabels: { enabled: !0, y: 15, borderWidth: 1, borderColor: 'silver', borderRadius: 3, style: { fontWeight: 'bold' }, verticalAlign: 'top', zIndex: 2 },
    dial: {},
    pivot: {},
  ...
  u = {
    ...
    translate: function() {
      ...
      s(this.points, function(d) {
        ...
        k = (k * 180) / Math.PI;
        d.shapeType = 'path';
        d.shapeArgs = { d: g.path || ['M', -i, -n / 2, 'L', e, -n / 2, f, -l / 2, f, l / 2, e, n / 2, -i, n / 2, 'z'], translateX: c[0], translateY: c[1], rotation: k };
        d.plotX = c[0];
        d.plotY = c[1];
      });
    },
      ...
      s(a.points, function(c) {
        ...
        b
          ...
          : (c.graphic = f[c.shapeType](g)
              .attr({ stroke: k.borderColor || 'none', 'stroke-width': k.borderWidth || 0, fill: k.backgroundColor || 'black', rotation: g.rotation })
              .add(a.group));
      });
      c
        ...
        : (a.pivot = f
            ...
            .attr({ 'stroke-width': g.borderWidth || 0, stroke: g.borderColor || 'silver', fill: g.backgroundColor || 'black' })
            .translate(b[0], b[1])
            .add(a.group));
    },
    animate: function(a) {
      ...
      s(b, function(b) {
        ...
        if (b.plotY !== C)
          if (
            ...
            x && ((k = (g['stroke-width'] % 2) / 2), (h = A(h) + k), (f = A(f) + k), (e = A(e) + k), (t += k), (v += k), (H = ['M', t, e, 'L', t, f, 'L', v, f, 'L', v, e, 'L', t, e, 'z'])),
            B && ((k = (E['stroke-width'] % 2) / 2), (i += k), (n += k), (p = ['M', h - u * B, i, 'L', h + u * B, i, 'M', h - u * B, n, 'L', h + u * B, n])),
  ...
  h.waterfall = x(h.column, {
    ...
    translate: function() {
      ...
      for (d = 0, c = g.length; d < c; d++) {
        ...
        f.isSum || f.isIntermediateSum ? ((e.y = b.translate(k[1], 0, 1)), (e.height = b.translate(k[0], 0, 1) - e.y)) : (l += i.total);
    ...
    processData: function(a) {
      ...
      i = e = h = l = f;
      for (j = 0; j < g; j++)
        (k = b[j]), (d = c && c[j] ? c[j] : {}), k === 'sum' || d.isSum ? (b[j] = i) : k === 'intermediateSum' || d.isIntermediateSum ? ((b[j] = e), (e = f)) : ((i += k), (e += k)), (h = Math.min(i, h)), (l = Math.max(i, l));
    ...
    getGraphPath: function() {
      var a = this.data,
        ...
        f,
        e;
      for (e = 1; e < b; e++) (f = a[e].shapeArgs), (g = a[e - 1].shapeArgs), (f = ['M', g.x + g.width, g.y + c, 'L', f.x, g.y + c]), a[e - 1].y < 0 && ((f[2] += g.height), (f[5] += g.height)), (d = d.concat(f));
      return d;
    },
    getExtremes: w,
    getStack: function(a) {
  ...
  h.bubble = x(h.scatter, {
    ...
    getRadii: function(a, b, c, d) {
      var g,
        ...
        i = this.zData,
        h = [];
      for (f = 0, g = i.length; f < g; f++) (e = b - a), (e = e > 0 ? (i[f] - a) / (b - a) : 0.5), h.push(t.ceil(c + e * (d - c)) / 2);
      this.radii = h;
    },
    animate: function(a) {
    ...
    translate: function() {
      ...
      for (a = b.length; a--; )
        (c = b[a]),
          ...
          d >= this.minPxSize / 2 ? ((c.shapeType = 'circle'), (c.shapeArgs = { x: c.plotX, y: c.plotY, r: d }), (c.dlBox = { x: c.plotX - d, y: c.plotY - d, width: 2 * d, height: 2 * d })) : (c.shapeArgs = c.plotY = c.dlBox = C);
    },
      ...
      (s(this.series, function(b) {
        ...
        if (b.type === 'bubble' && b.visible && ((a.allowZoomOutside = !0), q.push(b), f))
          s(['minSize', 'maxSize'], function(a) {
            ...
            (b = b.zData),
            b.length && ((k = t.min(k, t.max(P(b), c.displayNegative === !1 ? c.zThreshold : -Number.MAX_VALUE))), (m = t.max(m, Q(b))));
      }),
      s(q, function(a) {
        var b = a[e],
          c = b.length,
        ...
        if (o > 0) for (; c--; ) (j = a.radii[c]), (d = Math.min((b[c] - i) * p - j, d)), (g = Math.max((b[c] - i) * p + j, g));
      }),
      q.length && o > 0 && r(this.options.min, this.userMin) === C && r(this.options.max, this.userMax) === C && ((g -= b), (p *= (b + d - g) / b), (this.min += d / p), (this.max += g / p)));
  };
  var y = z.prototype,
  ...
  o(q, 'translate', function(a) {
    ...
    if (b.isRadial) {
      b = this.points;
      for (h = b.length; h--; ) (e = b[h]), (a = e.barX + g), (e.shapeType = 'path'), (e.shapeArgs = { d: f.symbols.arc(d[0], d[1], c - e.plotY, null, { start: a, end: a + e.pointWidth, innerR: c - r(e.yBottom, c) }) }), this.toXY(e);
    }
  });
