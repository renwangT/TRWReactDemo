...
(function(g) {
  ...
  var r = g.Axis,
    ...
    w = function() {};
  B.mapNavigation = {
    buttonOptions: { align: 'right', verticalAlign: 'bottom', x: 0, width: 18, height: 18, style: { fontSize: '15px', fontWeight: 'bold', textAlign: 'center' } },
    buttons: {
      zoomIn: {
        onclick: function() {
          this.mapZoom(0.5);
  ...
  t(r.prototype, 'getSeriesExtremes', function(a) {
    ...
    d = n(this.dataMax, Number.MIN_VALUE);
    l(this.series, function(a, i) {
      if (a.useMapGeometry) (c = Math.min(c, a[b ? 'minX' : 'minY'])), (d = Math.max(d, a[b ? 'maxX' : 'maxY'])), (a.xData = e[i]);
    });
    this.dataMin = c;
    this.dataMax = d;
  });
  ...
  t(y.prototype, 'render', function(a) {
    ...
    c.zoomOnDoubleClick &&
      g.addEvent(b.container, 'dblclick', function(a) {
        b.pointer.onContainerDblClick(a);
      });
    c.zoomOnMouseWheel &&
      g.addEvent(b.container, document.onmousewheel === void 0 ? 'DOMMouseScroll' : 'mousewheel', function(a) {
  ...
  v(z.prototype, {
    onContainerDblClick: function(a) {
      var b = this.chart,
        a = this.normalize(a);
      b.isInsidePlot(a.chartX - b.plotLeft, a.chartY - b.plotTop) && b.mapZoom(0.5, b.xAxis[0].toValue(a.chartX), b.yAxis[0].toValue(a.chartY));
    },
  ...
  v(y.prototype, {
          ...
          if (c.hasOwnProperty(d))
            (f = p(b.buttonOptions, c[d])),
              (e = a.renderer
                ...
                .add()),
              (e.handler = f.onclick),
              e.align(v(f, { width: e.width, height: e.height }), null, 'spacingBox');
    },
    ...
    mapZoom: function(a, b, c) {
      if (!this.isMapZooming) {
        ...
        b = d.fitToBox({ x: i, y: h, width: b, height: a }, { x: e.dataMin, y: f.dataMin, width: e.dataMax - e.dataMin, height: f.dataMax - f.dataMin });
  ...
  q.map = p(q.scatter, {
    ...
    turboThreshold: 0,
    tooltip: { followPointer: !0, pointFormat: '{point.name}: {point.y}<br/>' },
    states: { normal: { animation: !0 } },
  });
  r = g.extendClass(s, {
  ...
  k.map = g.extendClass(k.scatter, {
    ...
    init: function(a) {
      ...
      if ((h = b.options.valueRanges))
        l(h, function(a) {
          ...
          f !== void 0 && i !== void 0 && (e += ' - ');
          i !== void 0 && (e += A(i, c));
          d.push(g.extend({ chart: b.chart, name: e, options: {}, drawLegendSymbol: k.area.prototype.drawLegendSymbol, visible: !0, setState: function() {}, setVisible: function() {} }, a));
        }),
          (b.legendItems = d);
      else if (j)
        (f = j.from),
          ...
          o || ((o = h), (h = j), (j = o)),
          (o = {
            linearGradient: { x1: m[0], y1: m[1], x2: m[2], y2: m[3] },
            stops: [
              [0, f],
              [1, i],
            ],
          }),
          (d = [{ chart: b.chart, options: {}, fromLabel: h, toLabel: j, color: o, drawLegendSymbol: this.drawLegendSymbolGradient, visible: !0, setState: function() {}, setVisible: function() {} }]),
          (b.legendItems = d);
    },
    ...
    drawLegendSymbolGradient: function(a, b) {
      var c = a.options.symbolPadding,
        ...
        e,
        f,
        i = this.chart.renderer.fontMetrics(a.options.itemStyle.fontSize).h,
        h = a.options.layout === 'horizontal',
        j;
      j = n(a.options.rectangleLength, 200);
      h ? ((e = -(c / 2)), (f = 0)) : ((e = -j + a.baseline - c / 2), (f = d + i));
      b.fromText = this.chart.renderer
        .text(b.fromLabel, f, e)
        .attr({ zIndex: 2 })
        .add(b.legendGroup);
      f = b.fromText.getBBox();
      b.legendSymbol = this.chart.renderer
        .rect(h ? f.x + f.width + c : f.x - i - c, f.y, h ? j : i, h ? i : j, 2)
        .attr({ zIndex: 1 })
        .add(b.legendGroup);
      j = b.legendSymbol.getBBox();
      b.toText = this.chart.renderer
        .text(b.toLabel, j.x + j.width + c, h ? e : j.y + j.height - c)
        .attr({ zIndex: 2 })
        .add(b.legendGroup);
      e = b.toText.getBBox();
      h ? ((a.offsetWidth = f.width + j.width + e.width + c * 2 + d), (a.itemY = i + d)) : ((a.offsetWidth = Math.max(f.width, e.width) + c + j.width + d), (a.itemY = j.height + d), (a.itemX = c));
    },
    getBox: function(a) {
      ...
      l(a || this.options.data, function(a) {
        for (var i = a.path, h = i.length, j = !1, g = Number.MIN_VALUE, m = Number.MAX_VALUE, k = Number.MIN_VALUE, l = Number.MAX_VALUE; h--; )
          typeof i[h] === 'number' && !isNaN(i[h]) && (j ? ((g = Math.max(g, i[h])), (m = Math.min(m, i[h]))) : ((k = Math.max(k, i[h])), (l = Math.min(l, i[h]))), (j = !j));
        a._maxX = g;
        a._minX = m;
        a._maxY = k;
        a._minY = l;
    ...
    translateColors: function(a, b) {
      ...
      l(this.data, function(g) {
        ...
        else e && k !== void 0 && ((m = 1 - (b - k) / (b - a)), (l = k === null ? c.nullColor : x(i, h, m)));
        if (l) (g.color = null), (g.options.color = l);
      });
    },
    drawGraph: w,
    drawDataLabels: w,
    ...
    animateDrilldown: function(a) {
      ...
      if (!a)
        (a = Math.min(d.width / b.width, d.height / b.height)),
          (c.shapeArgs = { scaleX: a, scaleY: a, translateX: d.x, translateY: d.y }),
  ...
  k.mapline = g.extendClass(k.map, { type: 'mapline', pointAttrToOptions: { stroke: 'color', 'stroke-width': 'lineWidth', fill: 'backgroundColor' }, drawLegendSymbol: k.line.prototype.drawLegendSymbol });
  q.mappoint = p(q.scatter, { dataLabels: { enabled: !0, format: '{point.name}', color: 'black', style: { textShadow: '0 0 5px white' } } });
  k.mappoint = g.extendClass(k.scatter, { type: 'mappoint' });
  g.Map = function(a, b) {
    var c = { endOnTick: !1, gridLineWidth: 0, labels: { enabled: !1 }, lineWidth: 0, minPadding: 0, maxPadding: 0, startOnTick: !1, tickWidth: 0, title: null },
      d;
    d = a.series;
    a.series = null;
