...
(function() {
  function m() {
    ...
    a.Property = function(c, d) {
      ...
      this.Length = {
        ...
        toPixels: function(d) {
          ...
          var c = b.value + '';
          return c.match(/em$/)
            ? b.numValue() * this.EM(d)
            : c.match(/ex$/)
            ? (b.numValue() * this.EM(d)) / 2
            : c.match(/px$/)
            ? b.numValue()
            : c.match(/pt$/)
            ? b.numValue() * 1.25
            ...
            ? b.numValue() * 15
            : c.match(/cm$/)
            ? (b.numValue() * this.DPI(d)) / 2.54
            : c.match(/mm$/)
            ? (b.numValue() * this.DPI(d)) / 25.4
            : c.match(/in$/)
            ? b.numValue() * this.DPI(d)
            : c.match(/%$/)
            ? b.numValue() * a.ViewPort.ComputeSize(d)
            : b.numValue();
        },
      };
      this.Time = {
      ...
      this.addBezierCurve = function(b, a, d, c, k, l, o, n) {
        ...
        for (i = 0; i <= 1; i++)
          (b = function(b) {
            ...
            (c = 3 * p[i] - 3 * q[i]),
            d == 0
              ? a != 0 && ((a = -c / a), 0 < a && a < 1 && (i == 0 && this.addX(b(a)), i == 1 && this.addY(b(a))))
              : ((c = Math.pow(a, 2) - 4 * c * d),
                c < 0 ||
                  ((k = (-a + Math.sqrt(c)) / (2 * d)),
                  0 < k && k < 1 && (i == 0 && this.addX(b(k)), i == 1 && this.addY(b(k))),
                  (a = (-a - Math.sqrt(c)) / (2 * d)),
                  0 < a && a < 1 && (i == 0 && this.addX(b(a)), i == 1 && this.addY(b(a)))));
      };
    ...
    a.AspectRatio = function(c, d, b, k, e, f, g, j, h, l) {
      ...
      h.hasValue() && l.hasValue()
        ? c.translate(-p * h.Length.toPixels('x'), -p * l.Length.toPixels('y'))
        : (o.match(/^xMid/) && ((d == 'meet' && p == q) || (d == 'slice' && m == q)) && c.translate(b / 2 - k / 2, 0),
          o.match(/YMid$/) && ((d == 'meet' && p == n) || (d == 'slice' && m == n)) && c.translate(0, e / 2 - f / 2),
          o.match(/^xMax/) && ((d == 'meet' && p == q) || (d == 'slice' && m == q)) && c.translate(b - k, 0),
          o.match(/YMax$/) && ((d == 'meet' && p == n) || (d == 'slice' && m == n)) && c.translate(0, e - f));
    ...
    a.Element.RenderedElementBase = function(c) {
      ...
      this.setContext = function(d) {
        ...
        } else if (this.style('fill').hasValue()) (b = this.style('fill')), this.style('fill-opacity').hasValue() && (b = b.Color.addOpacity(this.style('fill-opacity').value)), (d.fillStyle = b.value == 'none' ? 'rgba(0,0,0,0)' : b.value);
    ...
    a.Element.rect = function(c) {
      ...
      this.path = function(d) {
        ...
        d != null &&
          ...
          d.moveTo(b + g, c),
          d.lineTo(b + e - g, c),
          d.quadraticCurveTo(b + e, c, b + e, c + j),
          d.lineTo(b + e, c + f - j),
          d.quadraticCurveTo(b + e, c + f, b + e - g, c + f),
          d.lineTo(b + g, c + f),
          d.quadraticCurveTo(b, c + f, b, c + f - j),
          d.lineTo(b, c + j),
          d.quadraticCurveTo(b, c, b + g, c),
          d.closePath());
    ...
    a.Element.ellipse = function(c) {
      ...
      this.path = function(d) {
        ...
        d != null &&
          (d.beginPath(),
          d.moveTo(f, g - e),
          d.bezierCurveTo(f + b * c, g - e, f + c, g - b * e, f + c, g),
          d.bezierCurveTo(f + c, g + b * e, f + b * c, g + e, f, g + e),
          d.bezierCurveTo(f - b * c, g + e, f - c, g + b * e, f - c, g),
          d.bezierCurveTo(f - c, g - b * e, f - b * c, g - e, f, g - e),
          d.closePath());
    ...
    a.Element.polyline = function(c) {
      ...
      this.path = function(d) {
        ...
        for (var c = 1; c < this.points.length; c++) b.addPoint(this.points[c].x, this.points[c].y), d != null && d.lineTo(this.points[c].x, this.points[c].y);
        return b;
      };
      this.getMarkers = function() {
      ...
      this.path = function(d) {
        ...
        for (d != null && d.beginPath(); !b.isEnd(); )
          switch ((b.nextCommand(), b.command.toUpperCase())) {
            ...
            case 'Q':
              for (; !b.isCommandOrEnd(); )
                (g = b.current), (j = b.getAsControlPoint()), (e = b.getAsCurrentPoint()), b.addMarker(e, j, j), c.addQuadraticCurve(g.x, g.y, j.x, j.y, e.x, e.y), d != null && d.quadraticCurveTo(j.x, j.y, e.x, e.y);
              break;
            case 'T':
              for (; !b.isCommandOrEnd(); )
            ...
            case 'A':
              for (; !b.isCommandOrEnd(); ) {
                ...
                c.addPoint(e.x, e.y);
                d != null &&
                  ((m = h > l ? h : l), (e = h > l ? 1 : h / l), (h = h > l ? l / h : 1), d.translate(g.x, g.y), d.rotate(f), d.scale(e, h), d.arc(0, 0, m, o, o + n, 1 - j), d.scale(1 / e, 1 / h), d.rotate(-f), d.translate(-g.x, -g.y));
              }
              break;
            case 'Z':
    ...
    a.Element.AnimateBase = function(c) {
      ...
      this.update = function(a) {
        ...
        if (this.duration > this.maxDuration)
          if (this.attribute('repeatCount').value == 'indefinite') this.duration = 0;
        ...
        this.duration += a;
        a = !1;
        if (this.begin < this.duration) (a = this.calcValue()), this.attribute('type').hasValue() && (a = this.attribute('type').value + '(' + a + ')'), (this.getProperty().value = a), (a = !0);
        return a;
      };
    ...
    a.Element.font = function(c) {
      ...
      for (c = 0; c < this.children.length; c++) {
        ...
        if (d.type == 'font-face') (this.fontFace = d), d.style('font-family').hasValue() && (a.Definitions[d.style('font-family').value] = this);
    ...
    a.Element.style = function(c) {
      ...
      this.base(c);
      for (
        var c = c.childNodes[0].nodeValue + (c.childNodes.length > 1 ? c.childNodes[1].nodeValue : ''), c = c.replace(/(\/\*([^*]|[\r\n]|(\*+([^*\/]|[\r\n])))*\*+\/)|(^[\s]*\/\/.*)/gm, ''), c = a.compressSpaces(c), c = c.split('}'), d = 0;
        d < c.length;
        d++
      )
        if (a.trim(c[d]) != '')
      ...
      var k = a.CreateElement(d.documentElement),
        ...
        f = function() {
          ...
          if (a.opts.ignoreDimensions != !0) {
            ...
            if (k.style('height').hasValue()) (c.canvas.height = k.style('height').Length.toPixels('y')), (c.canvas.style.height = c.canvas.height + 'px');
          }
  ...
  b(c.prototype, {
    ...
    setContainer: function(a, b, c) {
      var d = a.style,
        ...
        k = a.offsetWidth,
        m = a.offsetHeight,
        s = { visibility: 'hidden', position: 'absolute' };
    ...
    configure: function(b) {
      var c = this,
        ...
        m = k(m, { padding: t + 'px', 'background-color': d.backgroundColor, 'border-style': 'solid', 'border-width': f + 'px', 'border-radius': d.borderRadius + 'px' });
      d.shadow && (m = k(m, { 'box-shadow': '1px 1px 3px gray', '-webkit-box-shadow': '1px 1px 3px gray' }));
      a(g, m);
