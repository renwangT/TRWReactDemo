...
(function(f) {
  ...
  f.post = function(c, a) {
    var d, b;
    b = k('form', { method: 'post', action: c, enctype: 'multipart/form-data' }, { display: 'none' }, j.body);
  ...
  p(A.prototype, {
    ...
    exportChart: function(c, a) {
      var c = c || {},
        ...
        d = this.getSVG(o({ chart: { borderRadius: 0 } }, d.chartOptions, a, { exporting: { sourceWidth: c.sourceWidth || d.sourceWidth, sourceHeight: c.sourceHeight || d.sourceHeight } })),
    ...
    contextMenu: function(c, a, d, b, f, h, g) {
      var e = this,
        ...
        n;
      if (!i)
        (e[o] = i = k('div', { className: c }, { position: 'absolute', zIndex: 1e3, padding: s + 'px' }, e.container)),
          (v = k('div', null, p({ MozBoxShadow: '3px 3px 10px #888', WebkitBoxShadow: '3px 3px 10px #888', boxShadow: '3px 3px 10px #888' }, j.menuStyle), i)),
          (w = function() {
            u(i, { display: 'none' });
            g && g.setState(0);
            e.openMenu = !1;
    ...
    destroyExport: function(c) {
      ...
      for (a = 0; a < c.exportDivElements.length; a++) (d = c.exportDivElements[a]), C(d, 'mouseleave'), (c.exportDivElements[a] = d.onmouseout = d.onmouseover = d.ontouchstart = d.onclick = null), n(d);
    },
  });
