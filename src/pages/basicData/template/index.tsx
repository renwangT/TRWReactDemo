...
class Index extends MixinComponent {
  ...
  render() {
    ...
    return (
      <>
        <CustomFilter ref={this.filterFormRef} filterItem={this.filterItem} search={this.search}>
          <div>
            ...
            <Space>
              ...
              <Button type="primary" onClick={this.add} icon={<FileAddOutlined />}>
                新增
              </Button>
            </Space>
            <Divider />
        ...
        />
        <Modal {...this.props.model.modalConfig} onOk={this.onOk} onCancel={this.onCancel}>
          <CustomForm
